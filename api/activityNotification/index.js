...
module.exports = async function (context, req, teamsfxContext) {
  ...
  // console.log("Nitish id", context.req.body.userNitishId)
  // console.log("taskObj", context.req.body.notifyBody);
  ...
  try {
    ...
    const profile = await graphClient
      .api(
        `/users/${context.req.body.userNitishId}/teamwork/sendActivityNotification`
      )
      .post(context.req.body.notifyBody);
